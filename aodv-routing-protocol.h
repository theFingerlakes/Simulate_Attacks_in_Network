...
modified code for ns-3.33/src/aodv/model/aodv-routing-protocol.h
...
public:
  ...
  /*Method to enable/disable grayhole attack feature*/
  void SetGrayAttackEnable (bool f) { EnableGrayAttack =f; }
  /*Method to get the status of grayhole attack feature*/
  bool GetGrayAttackEnable () const { return EnableGrayAttack; }
  /*Method to enable/disable blackhole feature*/
  void SetBlackAttackEnable (bool f) { EnableBlackAttack =f; }
  /*Method to get the status of blackhole feature*/
  bool GetBlackAttackEnable () const { return EnableBlackAttack; }
  ...
  /*Attributes for wormhole tunnel*/
...
private:
  ...
  **/
  ...
  bool EnableWrmAttack; //wormhole attack
  bool EnableGrayAttack; // grayhole attack                                          
  bool EnableBlackAttack; //blackhole attack
