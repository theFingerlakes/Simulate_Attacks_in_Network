...
NS_LOG_COMPONENT_DEFINE ("grayhole-aodv");
/*
ENSC 894 Communication Networks
  ...
  */
  ...
  node_list[4] = 60;
	for(int i =0; i<5; i++){
      ...
      */
		  FILENAME_PREFIX = "grayhole-" + std::to_string(nWifis) + "+" + std::to_string(nmalicious);
...
RoutingExperiment::Run (int nSinks, double txp, std::string CSVfileName)
{
  ...
  */
  malicious_aodv.Set("EnableGrayAttack",BooleanValue(true)); // putting *false* instead of *true* would disable the malicious behavior of the node
  ...
  */
  ...
  for (uint32_t i = 0; i < malicious.GetN (); ++i)
    {
      anim.UpdateNodeDescription (malicious.Get (i), "G"); 
